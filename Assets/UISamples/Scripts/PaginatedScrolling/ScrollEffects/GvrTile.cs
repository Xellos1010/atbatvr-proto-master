...
public class GvrTile : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IGvrPointerHoverHandler {
  ...
  private GvrTiledPage GetPage() {
    if (page == null) {
      page = GetComponentInParent<GvrTiledPage>();
    }
