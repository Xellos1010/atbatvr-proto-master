...
[Serializable]
public class DictNewsPhotos : SerializableDictionary<string, NewsItemPhoto> { }

[CustomPropertyDrawer(typeof(DictionaryStringInt))]
public class MyDictionaryDrawer1 : DictionaryDrawer<string, int> { }

[CustomPropertyDrawer(typeof(DictNewsPhotos))]
public class DictionaryNewsPhotos : DictionaryDrawer<string, NewsItemPhoto> { }