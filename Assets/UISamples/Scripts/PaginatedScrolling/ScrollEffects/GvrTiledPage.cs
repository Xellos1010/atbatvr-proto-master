...
public class GvrTiledPage : MonoBehaviour {
  ...
  /// <summary>
  /// Called by GvrPagedScrollRect when scrolling occurs.
  ...
  /// <param name="isInteractable">True is the GvrPagedScrollRect is currently scrolling.</param>
  ...
  private void UpdateTile(Transform tile, Vector3 position, bool isInteractable) {
    ...
    GvrTile gvrTile = tile.GetComponent<GvrTile>();
    if (gvrTile != null) {
      gvrTile.IsInteractable = isInteractable;
    }
  }
